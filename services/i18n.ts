...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    groups: 'Tribes',
    files: 'Vault',
    creator_studio: 'Creator Hub',
    leave: 'Leave Hub',
    recording: 'Echoing',
    support_creator: 'Support Node',
    join_conversation: 'Join Hub',
    launch_room: 'Launch Hub',
    welcome_back: 'Welcome to the Hub',
    join_tribe: 'Join Tribe',
    revenue: 'Yield',
    audience: 'Listeners',
    ledger: 'Revenue Ledger',
    native_lang: 'Native Dialect'
  },
  fr: {
    app_name: 'Chat-Chap',
    rooms: 'Découverte',
  ...
  es: {
    ...
    leave: 'Salir',
    recording: 'Grabando Eco',
    support_creator: 'Apoyar',
    join_conversation: 'Unirse',
    launch_room: 'Lanzar Hub',
    welcome_back: 'Bienvenido al Hub',
  ...
  pt: { app_name: 'Chat-Chap', rooms: 'Descoberta', calls: 'Conectar', pulse: 'Pulso', schedule: 'Agenda', groups: 'Tribos', files: 'Cofre', creator_studio: 'Estúdio', leave: 'Sair', recording: 'Ecoando', support_creator: 'Apoiar', join_conversation: 'Entrar', launch_room: 'Lançar', welcome_back: 'Bem-vindo', join_tribe: 'Entrar na Tribo', revenue: 'Receita', audience: 'Público', ledger: 'Livro', native_lang: 'Língua Nativa' },
  de: { app_name: 'Chat-Chap', rooms: 'Entdeckung', calls: 'Verbinden', pulse: 'Puls', schedule: 'Zeitplan', groups: 'Stämme', files: 'Safe', creator_studio: 'Studio', leave: 'Verlassen', recording: 'Echoaufnahme', support_creator: 'Unterstützen', join_conversation: 'Beitreten', launch_room: 'Starten', welcome_back: 'Willkommen', join_tribe: 'Beitreten', revenue: 'Einnahmen', audience: 'Publikum', ledger: 'Hauptbuch', native_lang: 'Muttersprache' },
  zh: { app_name: 'Chat-Chap', rooms: '发现', calls: '连接', pulse: '脉搏', schedule: '日程', groups: '部落', files: '保管库', creator_studio: '工作室', leave: '离开', recording: '回声录制', support_creator: '支持', join_conversation: '加入对话', launch_room: '启动', welcome_back: '欢迎回来', join_tribe: '加入', revenue: '收入', audience: '受众', ledger: '分类账', native_lang: '母语' },
  ...
  sw: { app_name: 'Chat-Chap', rooms: 'Gundua', calls: 'Ungana', pulse: 'Mapigo', schedule: 'Ratiba', groups: 'Vikundi', files: 'Faili', creator_studio: 'Studio', leave: 'Ondoka', recording: 'Kurekodi', support_creator: 'Saidia', join_conversation: 'Jiunge', launch_room: 'Anzisha', welcome_back: 'Karibu tena', join_tribe: 'Jiunge', revenue: 'Mapato', audience: 'Watazamaji', ledger: 'Leja', native_lang: 'Lugha ya Asili' },
